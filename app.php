<?php
	...
	class Conexao {
		...
		public function conectar(){
			try{
				...
				//faz com que a instancia trabalhe com utf8
	...
	class Bd {
		...
		//tipando a instancia para que o parametro passado seja do tipo esperado - OBS: não é obrigatorio
	...
	//explode para separar mês e ano pois esta vindo do front tudo junto
	$competencia = explode('-',$_GET['competencia']);
	$ano = $competencia[0];
	$mes = $competencia[1];

	//função nativa para verificar a quantidade dias, oarametros(calendar, month, year)
	...
	//print_r($dashboard);
	//transcreve o objeto para uma string json
